...
for np in ['gp2010', 'gp2015']:
    ...
    for l in links:
        ...
        if m:
            ...
            district = 'हरिद्वार'
            print(href, col, row, l.text.strip(), '<%s>, <%s>' % (h1, h2), district, declare_result, unopposed_elected)
            #print('-'*50)
        if href:
...
out_df.to_csv('data/uttarakhand-panchayat-elections-haridwar.csv', index=False)
